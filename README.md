...
This Alexa skill procures air quality rating via an external API web service from the [BreezeOMeter API](http://api.breezometer.com/baqi/).
...
4. Name the Lambda Function "Air-Quality-Example-Skill".
...
2. Set "Air Quality Meter" for the skill name and "Air Quality Meter" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, ask Air Quality Meter what is the air rating for 98105."
...
### One-shot model:
    User:  "Alexa, ask Air Quality Meter what is the air rating for 98105."
    Alexa: "The air quality in zip code 98105 is rated Fair."
